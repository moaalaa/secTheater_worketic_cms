                        ...
                        @if (!empty($freelancer))
                            ...
                            <div class="wt-projecthistory">
                                ...
                                <div class="wt-historycontent la-jobdetails-holder">
                                    <private-message :placeholder="'{{ trans('lang.ph_job_dtl') }}'" :upload_tmp_url="'{{url('service/upload-temp-message_attachments')}}'" :id="'{{$id}}'" :recipent_id="'{{$freelancer->id}}'" :project_type="'service'"></private-message>
                                </div>
                            </div>
                        @endif
                    </div>
