                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-personalskillshold tab-pane active show">
                            <?php echo Form::open(['url' => '', 'class' =>'wt-userform', 'id' => 'user_data', '@submit.prevent' => 'submitUserProfile']); ?>
                                ...
                                <div class="wt-profilephoto wt-tabsinfo">
                                    <?php echo $__env->make('back-end.settings.profile_photo', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                                <div class="wt-bannerphoto wt-tabsinfo">
                                    <?php echo $__env->make('back-end.settings.profile_banner', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
