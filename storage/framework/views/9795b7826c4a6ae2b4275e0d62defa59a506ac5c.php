...
<?php $__env->startSection('content'); ?>
    <?php if($show_job_banner == 'true'): ?>
        ...
        <div class="wt-haslayout wt-innerbannerholder" style="background-image:url(<?php echo e(asset(Helper::getBannerImage('uploads/settings/general/'.$job_inner_banner))); ?>)">
            <div class="container">
